...
const { sanitizeContent } = require('./middleware/validationMiddleware');
...
io.on('connection', (socket) => {
    ...
    socket.on('send_message', async (data) => {
        ...
        try {
            ...
            const messageToSave = new Message({ group: groupId, sender: senderId, text: sanitizeContent(text.trim()) });
