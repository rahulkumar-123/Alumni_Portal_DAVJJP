...
// Helper to escape regex special characters to prevent ReDoS attacks
...
exports.getUsers = async (req, res) => {
    ...
    try {
        ...
        if (currentOrganization) filter.currentOrganization = { $regex: escapeRegex(currentOrganization), $options: 'i' };
...
exports.approveRegistration = async (req, res) => {
    ...
    <div style="font-family:Segoe UI, Roboto, sans-serif; max-width:600px; margin:auto; padding:20px; border-radius:8px; background:#f9f9f9; color:#333;">
      ...
      <p style="margin:25px 0;">
        <a href="${process.env.CLIENT_URL || 'https://alumni-portal-davjjp.vercel.app'}" 
