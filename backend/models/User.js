...
UserSchema.index({ isApproved: 1, batchYear: 1 });      // Alumni directory filter
UserSchema.index({ isApproved: 1, createdAt: 1 });       // Directory sort
UserSchema.index({ isApproved: 1, dateOfBirth: 1 });     // Birthday queries
