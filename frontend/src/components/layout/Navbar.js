                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="flex h-16 justify-between items-center">
                            ...
                            <div className="flex items-center">
                                <Link to="/" className="text-lg sm:text-xl lg:text-2xl font-extrabold text-primary flex items-center shrink-0">
                            ...
                            <div className="flex items-center space-x-2 sm:space-x-4">
                                {user ? (
                                        ...
                                        <Menu as="div" className="hidden sm:block relative">
                                            <div>
                                                <Menu.Button className="flex rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 hover:ring-2 hover:ring-primary/50 transition-all">
                                                    ...
                                                    <img className="h-8 w-8 sm:h-9 sm:w-9 rounded-full object-cover"
                                            ...
                                            <Transition as={Fragment}
                                                ...
                                                <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-surface py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                                    <Menu.Item>
                                                        {({ active }) => (
                                                            <Link to="/profile" className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-muted hover:text-on-surface')}>
                                                                Your Profile
                                                            </Link>
                                                        )}
                                                    </Menu.Item>
                                                    <Menu.Item>
                                                        {({ active }) => (
                                                            <button onClick={handleLogout}
                                                                className={classNames(active ? 'bg-gray-100' : '', 'block w-full text-left px-4 py-2 text-sm text-muted hover:text-on-surface')}>
                                                                Sign out
                                                            </button>
                                                        )}
                                                    </Menu.Item>
                                    ...
                                    <div className="hidden sm:flex items-center space-x-2">
                                        <Link to="/login" className="text-sm font-semibold text-muted hover:text-primary transition-colors px-3 py-2 rounded-md hover:bg-gray-100">
                                            Sign In
                                        </Link>
                                        <Link to="/register" className="inline-flex items-center rounded-lg bg-primary px-3 py-2 text-sm font-semibold text-white shadow-md hover:bg-primary-dark transition-colors">
                                            Register
                                        </Link>
                                    </div>
                                )}
                                ...
                                >
                                    {item.onClick ? (
                                        ...
                                        <NavLink to={item.href} onClick={close}
                                            className={({ isActive }) =>
                                                classNames(isActive ? 'bg-primary/10 text-primary border-l-4 border-primary' : 'text-muted hover:bg-gray-100 hover:text-on-surface',
                                    ...
                                    <div className="flex items-center justify-between px-3 py-2 mb-3 bg-gray-50 rounded-lg">
                                        <div className="flex items-center min-w-0 flex-1">
                                            ...
                                            <div className="ml-3 min-w-0 flex-1">
                                                <div className="text-base font-medium text-on-surface truncate">{user.fullName}</div>
                                                <div className="text-sm font-medium text-muted truncate">{user.email}</div>
                                            </div>
                                        </div>
                                    </div>
